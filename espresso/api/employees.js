...
// Retrieve single Employee From Database given the right employeeID
employeesRouter.get('/:employeeId', (req, res, next) => {
  res.status(200).json({employee: req.employee});
});

// Create new Employee, add to Database as long as all required fields are there.
...
// Update Employee when required fields are provided in request.
...
// Delete Employee from Database based on EmployeeId.
